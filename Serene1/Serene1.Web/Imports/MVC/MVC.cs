...
namespace MVC
{
    public static class Views
    {
        ...
        {
            public static class AppCampos
            {
                public const string AppCamposIndex = "~/Modules/CLIN/AppCampos/AppCamposIndex.cshtml";
            }

            public static class AppFormulario
            {
                public const string AppFormularioIndex = "~/Modules/CLIN/AppFormulario/AppFormularioIndex.cshtml";
            }

            public static class Estados
            {
                public const string EstadosIndex = "~/Modules/CLIN/Estados/EstadosIndex.cshtml";
            }

            public static class Grupos
            {
                public const string GruposIndex = "~/Modules/CLIN/Grupos/GruposIndex.cshtml";
            }

            public static class Modulo
            {
                public const string ModuloIndex = "~/Modules/CLIN/Modulo/ModuloIndex.cshtml";
            }

            public static class PlantillaCorreo
            {
                public const string PlantillaCorreoIndex = "~/Modules/CLIN/PlantillaCorreo/PlantillaCorreoIndex.cshtml";
            }

            public static class Profesiones
            {
                public const string ProfesionesIndex = "~/Modules/CLIN/Profesiones/ProfesionesIndex.cshtml";
            }
